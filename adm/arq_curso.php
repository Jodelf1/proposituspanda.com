<?php 
    ...
    $cursosql = "SELECT * FROM cursos_tb WHERE estado = '2'";
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <a href="javascript: if(confirm('Tem certeza que pretende desarquivar <?php echo addslashes($curso['nome'])?>?'))
                        location.href='acao_curso.php?cursoid=<?php echo $curso['curso_id'];?>&acao=3'" class="arquivar"><ion-icon name="share-outline"></ion-icon></a></td>
                    </tr>
