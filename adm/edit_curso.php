        ...
        <div class="adm_main">
            ...
            <div class="novocurso">
                <form action="" method="post">
                    ...
                    <div class="form-row">
                        <div class="col">
                          <input type="text" class="form-control" name="nome_curso" placeholder="Digite aqui o nome do curso" value="<?php echo $curso['nome']?>" required>
                        </div>
                    </div><br>
                    <div class="form-row">
                        <div class="col">
                          <input type="number" class="form-control" name="preco_in_curso" value="<?php echo $curso['prc_in']?>" placeholder="Digite aqui o preço de incrição do curso" required>
                        </div>
                    </div>
                    <br>
                    <div class="form-row">
                        <div class="col">
                          <input type="number" class="form-control" name="preco_curso" value="<?php echo $curso['prc']?>" placeholder="Digite aqui o preço do curso" required>
                        </div>
                    </div>
                    <br>
                    <div class="input-group">
                        ...
                        <textarea class="form-control" name="descricao_curso" aria-label="With textarea" required><?php echo $curso['descricao']?></textarea>
                      </div>
                      <br>
