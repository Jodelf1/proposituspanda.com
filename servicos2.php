...
<body>
    ...
    <main>
        <img class="eli1" src="./assets/img/Ellipse 6.svg" alt="">
        <img class="eli2" src="./assets/img/Ellipse 7.svg" alt="">
        ...
        <div class="fim">
            ...
            <div class="ft2">
                <ul class="footer-menu">
                    <li class="item"><a href="#qsms">Quem somos?</a></li>
                    <li class="item"><a href="./cursos.php">Serviços</a></li>
                    <li class="item"><a href="./galeria.php">Cursos</a></li>
                    <li class="item ativo"><a href="#">Login</a></li>
                </ul>
            </div>
            <div class="ft3">
                <p>Contacte-nos</p>
